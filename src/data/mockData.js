...
export const fieldTelemetry = {
  ...
  humidityUnit: '%',
  soilMoisture: 42,
  soilStatus: 'Optimal for vegetative tillering (35–50%)',
  rainProbability: 25,
  rainForecast: 'Scattered Cauvery delta showers expected in 12h',
  windSpeed: 12,
  windUnit: 'KM/H',
  cropHealth: 92,
  cropHealthMax: 100,
  cropHealthStatus: 'Optimal tillering vigor',
  expectedYield: 5200,
  yieldUnit: 'KG',
  marketDemand: 4500,
...
export const defaultAgents = [
  {
    ...
    decision: 'NO_ACTION',
    detail: 'Soil moisture adequate (42%) for tillering',
    status: 'ACTIVE',
    alert: false,
  },
  {
    ...
    decision: 'LOW STRESS',
    detail: '92/100 Health • 5,200 KG expected harvest',
    status: 'ACTIVE',
    alert: false,
  },
  {
    ...
    detail: '4,500 KG demand • 700 KG to state civil procurement',
    status: 'ACTIVE',
    alert: false,
  },
  {
    ...
    decision: 'PLAN ACTIVE',
    detail: '3 prioritized instructions synthesized',
    status: 'ACTIVE',
    alert: false,
  },
];
...
export const defaultActionPlan = [
  {
    id: '01',
    title: 'MAINTAIN TILLERING WATER LEVEL',
    impact: 'Conserve canal water & regulate depth to 3–5 cm',
    context: 'Soil moisture at 42% is in optimal tillering range for Ponni Samba paddy; avoid excess canal pumping.',
    priority: 'HIGH',
    source_agents: ['FARMSENSE', 'CROPGUARD'],
  },
  {
    id: '02',
    title: 'PREPARE FOR VEGETATIVE HARVEST STAGE',
    impact: 'Projected yield: 5,200 KG',
    context: 'Crop vigor index at 92/100; panicle initiation tracking initiated for Cauvery delta seasonal cycle.',
    priority: 'MEDIUM',
    source_agents: ['CROPGUARD'],
  },
  {
    id: '03',
    title: 'ROUTE PLANNED SURPLUS',
    impact: '700 KG → State Procurement & Food Rescue',
    context: 'Commercial mandi demand confirmed at 4,500 KG; remaining 700 KG pre-allocated to prevent post-harvest loss.',
    priority: 'MEDIUM',
